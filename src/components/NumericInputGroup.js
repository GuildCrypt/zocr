...
module.exports = class NumericInputGroup extends Element {
  constructor(label, units, min, max, maxPrecision) {
    ...
    appendText.$.classList.add('input-group-text')
    appendText.$.innerText = units
    appendText.$.style.width = 60
  ...
  setErrorAlert(message) {
    this.errorAlert.$.innerText = message
